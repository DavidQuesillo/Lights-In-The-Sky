...
public class MountCrushParticlesPool : pool
{
    ...
    private static MountCrushParticlesPool instance;
    public static new MountCrushParticlesPool Instance { get { return instance; } }
