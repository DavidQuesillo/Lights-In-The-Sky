...
public class ElecRayKillParticlesPool : pool
{
    ...
    private static ElecRayKillParticlesPool instance;
    public static new ElecRayKillParticlesPool Instance { get { return instance; } }
