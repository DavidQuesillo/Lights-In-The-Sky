...
public class IceDagKillParticlesPool : pool
{
    ...
    private static IceDagKillParticlesPool instance;
    public static new IceDagKillParticlesPool Instance { get { return instance; } }
