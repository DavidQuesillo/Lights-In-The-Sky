...
public class KarmicDetonatorExplosionPool : pool
{
    ...
    private static KarmicDetonatorExplosionPool instance;
    public static new KarmicDetonatorExplosionPool Instance { get { return instance; } }
